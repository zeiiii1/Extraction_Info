...
def parse_quaero(input_dir, output_file):
...
if __name__ == "__main__":
    input_dir = "../Corpus/QUAERO_FrenchMed/corpus/train/"
    output_file = "../Outputs/quaero_bio.txt"
    parse_quaero(input_dir, output_file)
    print("QUAERO parsing completed.")